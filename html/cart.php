...
if (isset($_SESSION["cart_item_list"])) {
  $items = $_SESSION["cart_item_list"];
  $quantities = $_SESSION["cart_item_quantity"];
...
$indexNo = 0;
  for($x = 0; $x < $arrlength; $x++) {
    ...
    $qry = "SELECT * FROM medicine_list WHERE medicine_id LIKE '$m_id';";
    ...
    if(mysqli_num_rows($result) > 0){
      ...
      $m_price = $row["medicine_price"];

      $quantity = $quantities[$x];

      echo '
      <div id="items">
        <p><b>Medicine: </b>'.$m_name.'</p>
        <p><b>Price: </b>$'.$m_price.'</p>

        <div id="quantity">
          <p><b>Quantity: </b>'.$quantity.'</p>
          <p><b><a class="btn" href="../php/decrease_q.php?indexNo='.$indexNo.'">-</a></b> <b><a class="btn" href="../php/increase_q.php?indexNo='.$indexNo.'">+</a></b> <b><a class="btn" href="">X</a></b></p>
        </div>
      </div>
      ';
...
<section class="container">
  <a id="continueBtn" class="btn" href="../php/verify_login.php">Continue</a>
</section>
